...
public interface CacheNames {
    String REST_NAF_COACH = "DomainNafCoach";
    String DOMAIN_NAF_COACH = "RestNafCoach";

    String ARENA_RACES = "ArenaRaces";
    String ARENA_TEAMS = "ArenaTeams";
    ...
    String MARATHON_DATASET = "marathonDataset";
