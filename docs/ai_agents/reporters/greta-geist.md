...
rating:
  ...
  bias:
    own_race_affinity: 0.15
    own_race_expectation: 0.20
  preferences:
    reliability: 0.90
    impact: 1.00
    technical_execution: 0.85
    turnover_avoidance: 0.90
  guidance: >-
    A demanding specialist in individual performance and form. Ratings are usually coherent and well justified.
