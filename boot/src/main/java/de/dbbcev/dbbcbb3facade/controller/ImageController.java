...
import de.dbbcev.dbbcbb3facade.cyanide.api.model.common.Skill;
import de.dbbcev.dbbcbb3facade.domain.cache.ImageCache;
import de.dbbcev.dbbcbb3facade.domain.cache.ImageCacheRepository;
...
public class ImageController {
    ...
    private ResponseEntity<byte[]> loadImage(String imageUrl, Optional<Integer> maxWidth) {
        ...
        if (!cacheOutdated) {
            log.info("Got image for url '{}' from cache.", imageUrl);
