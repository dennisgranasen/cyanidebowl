package de.dbbcev.dbbcbb3facade.cyanide.api.model.contests;
...
public class ContestsResponse extends ApiResponse {
    private Match[] upcoming_matches;
    ...
    public static class Match {
        public enum Type {best_of_1, single_match}

        public enum Status {scheduled, played}
