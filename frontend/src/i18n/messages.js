const en = {
  ...
  "community.sort": "Sort by",
  "community.name": "Name",
  "community.joined": "Member since",
  "community.comments": "Comment count",
  "community.direction": "Order",
  "community.ascending": "Ascending / oldest first",
  "community.descending": "Descending / newest first",
  "community.seasonHelp": "Season refers to the team's participation, not historical membership status. Multiple seasons are sorted by season name.",
  "community.reset": "Reset filters",
  "community.results": "{count} of {total} members",
  "community.commentCount": "{count} comments",
  "community.commentHistory": "Written comments",
  "community.noComments": "No published comments.",
  "community.moreComments": "Show more comments",
  "community.commentsError": "Could not load comments.",
  "community.discussionUnavailable": "This discussion is unavailable or unpublished.",
  "community.openSource": "Open the page being discussed",
  ...
  "news.type.STAR_PLAYER": "Star player",
  "news.imageWorldContext": "All illustrations belong to the Blood Bowl universe. The current article or match provides context.",
  "news.imageSubjects": "Tag subjects in this image",
  "news.imageTextReferencesOnly": "The illustration used star player facts. Portrait references require an image service that supports reference images.",
  "news.imageSubjectsHelp": "Tags bring profiles and facts into the illustration. Tagged fans always comment when the article is published; reporters may comment. Star players include portrait references.",
  ...
  'nav.home': 'Home',
  'nav.admin': 'Admin',
  'news.backToSeason': 'Back to season',
  'menu.title': 'Menu',
  'menu.home': 'Home',
...
const sv = {
  ...
  "community.status": "Status",
  "community.active": "Aktiv",
  "community.inactive": "Inaktiv",
  "community.sort": "Sortera efter",
  "community.name": "Namn",
  "community.joined": "Medlem sedan",
  "community.comments": "Antal kommentarer",
  "community.direction": "Ordning",
  "community.ascending": "Stigande / äldst först",
  "community.descending": "Fallande / nyast först",
  "community.seasonHelp": "Säsong avser lagets deltagande, inte historisk medlemsstatus. Flera säsonger sorteras efter säsongsnamn.",
  "community.reset": "Återställ filter",
  "community.results": "{count} av {total} medlemmar",
  "community.commentCount": "{count} kommentarer",
  "community.commentHistory": "Skrivna kommentarer",
  "community.noComments": "Inga publicerade kommentarer.",
  "community.moreComments": "Visa fler kommentarer",
  "community.commentsError": "Kommentarerna kunde inte hämtas.",
  "community.discussionUnavailable": "Kommentarsflödet finns inte eller är inte publicerat.",
  "community.openSource": "Öppna sidan som diskuteras",
  ...
  "news.type.STAR_PLAYER": "Star player",
  "news.imageWorldContext": "Alla illustrationer hör hemma i Blood Bowl-universumet. Den aktuella artikeln eller matchen ger kontext.",
  "news.imageSubjects": "Tagga motiv i bilden",
  "news.imageTextReferencesOnly": "Bilden använde fakta om star players. Porträttreferenser kräver en bildtjänst som stöder referensbilder.",
  "news.imageSubjectsHelp": "Taggar tar med profiler och fakta till bilden. Taggade fans kommenterar alltid när artikeln publiceras; reportrar kan kommentera. Star players får med porträttreferenser.",
  ...
  'nav.home': 'Hem',
  'nav.admin': 'Admin',
  'news.backToSeason': 'Tillbaka till säsongen',
  ...
  'menu.login': 'Logga in',
  'menu.createAccount': 'Skapa konto',
