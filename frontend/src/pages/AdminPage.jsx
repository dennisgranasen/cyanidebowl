...
function AdminPage() {
  ...
  useEffect(() => {
    if (authenticationReady && (userPermissions.writeSiteAdmin || userPermissions.writeLeagueAdmin)) loadSystems();
