  ...
  return (
    <Box fontSize={headerSize} {...props}>
      ...
      <VStack align="left">
        ...
        <Text fontSize={textSize}>
          <a href="https://www.buymeacoffee.com/d.rock"><img src="https://img.buymeacoffee.com/button-api/?text=Muta blaskan!&emoji=&slug=d.rock&button_colour=40DCA5&font_colour=ffffff&font_family=Bree&outline_colour=000000&coffee_colour=FFDD00" /></a>
        </Text>
        <Text>
