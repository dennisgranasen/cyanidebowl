...
function Menu() {
    ...
    return (
        <>
            <Link onClick={onOpen}>
                <Avatar borderRadius={4} boxSize={12} icon={<HamburgerIcon/>}
                        src={ImageUrls.warpscoresLogoPng('medium')}>
                    ...
                    >
                        ...
                        >
                            ...
                            <VStack align="left">
                                ...
                                <SocialLinks socialLinks={status?.socialLinks} headerSize="sm" iconSize="sm" mt={2}
                                             color="grey"/>
