...
function Ranks({ ranks, teams, competitionId, loading, error }) {
  return (
        ...
        <Table variant="stripedClickable" size="sm">
          ...
          <Tbody>
            { ranks?.map((rank, index) => {
                ...
                return <Rank competitionId={competitionId} /*logo={teamLogo}*/ rank={rank} position={index + 1} key={rank.teamId.key} />;
            })}
          </Tbody>
          <Tfoot>
            <TableColumns />
