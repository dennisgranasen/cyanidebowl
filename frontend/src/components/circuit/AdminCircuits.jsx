...
function AdminCircuits() {
    ...
    return (
        <VStack align="left">
                    ...
                    <>
                        ...
                        <SimpleGrid columns={{base: 1, md: 2, lg: 3}} spacing="1rem" mb="1rem">
                            {circuits.map((circuit) => (
                                <CircuitCard key={circuit.circuitId} circuit={circuit} showConfigureLink
                                             variant="outline"/>
                            ))}
                        </SimpleGrid>
                    </>
            ...
            <Box mb="1rem">
                Circuits are a collection of leagues and/or competitions that you consider to belong together in order
                to obtain
                statistics. For example, an ‘NAF Tournament’ circuit could contain all tournaments (competitions)
                organised by
                the NAF or the ‘Cyanide World Cup Qualifiers’ circuit could contain all leagues and competitions that
                include
